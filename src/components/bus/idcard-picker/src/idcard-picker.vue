 ...
 * @LastEditTime: 2019-09-26 17:58:40
 ...
 <template>
  <div class="sun-idcard-picker">
    ...
    <div class="sun-idcard-picker-pickers" v-if="termType === 'short'">
      ...
      <div class="sun-idcard-picker-pickers-inputs">
        <div class="sun-idcard-picker-pickers-inputs-item" @click="clickCell('start')">
          ...
          <span type="text" class="sun-idcard-picker-pickers-inputs-input"
            :class="startDate ? '' : 'sun-idcard-picker-pickers-inputs-placeholder'">{{startDate ?
        ...
        <div class="sun-idcard-picker-pickers-inputs-item" @click="clickCell('end')">
          <i class="sun-idcard-picker-pickers-inputs-icon"></i>
          <span type="text" class="sun-idcard-picker-pickers-inputs-input"
            :class="endDate ? '' : 'sun-idcard-picker-pickers-inputs-placeholder'">{{endDate
    ...
    <sun-popup v-model="showPicker" :zIndex="zIndex" position="bottom" :get-container="getContainer"
      ...
      <sun-datetime-picker v-show="showPicker" type="date" :value="computeDate" showToolbar :minDate="minDate"
        :maxDate="maxDate" @cancel="onCancel" @confirm="onConfirm" />
    </sun-popup>
  </div>
</template>
