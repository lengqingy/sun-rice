 ...
 * @LastEditTime: 2019-09-25 10:05:46
 * @LastEditors: Please set LastEditors
 -->
<template>
  <div class="sun-address-picker-cell">
    <sun-cell :title="title" :value="address" :border="border" center clickable arrowDirection="right"
      @click="clickCell">
      <slot name="extra" v-if="placeholder && !address"><span
          class="sun-address-picker-cell-placeholder">{{placeholder}}</span></slot>
    </sun-cell>
