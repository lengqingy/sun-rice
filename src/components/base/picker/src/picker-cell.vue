 ...
 * @LastEditTime: 2019-09-25 09:53:10
...
<template>
  <div class="sun-picker-cell">
    <sun-cell :title="title" :value="computeValue" :border="border" center clickable arrowDirection="right"
      @click="clickCell">
      <slot name="extra" v-if="placeholder && !(computeValue === 0|| computeValue === '0' || computeValue)"><span
    ...
    <sun-popup v-model="showPicker" :zIndex="zIndex" position="bottom" :get-container="getContainer"
      ...
      <sun-picker :title="title" :loading="loading" :showToolbar="showToolbar" :confirmButtonText="confirmButtonText"
        :cancelButtonText="cancelButtonText" :visibleItemCount="visibleItemCount" :valueKey="valueKey"
        :itemHeight="itemHeight" :columns="columns" @cancel="onCancel" @confirm="onConfirm" />
    </sun-popup>
  </div>
</template>
