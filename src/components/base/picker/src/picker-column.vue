 ...
 * @LastEditTime: 2019-09-25 09:53:40
 * @LastEditors: Please set LastEditors
 -->

<template>
  <div :class="['sun-picker-column', className]" :style="columnStyle" @touchstart="onTouchStart"
    ...
    <div :style="wrapperStyle">
      <div v-for="(option, index) in options" :key="index" v-html="getOptionText(option)" class="sun-ellipsis" :class="['sun-picker-column-item', {
        ...
        }]" @touchstart.stop="onTouchStart" @touchmove.prevent.stop="onTouchMove" @touchend.stop="onTouchEnd"
        @touchcancel.stop="onTouchEnd" @click="setIndex(index, true)" />
    </div>
  </div>
</template>
