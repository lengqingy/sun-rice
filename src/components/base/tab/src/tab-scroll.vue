 ...
 * @LastEditTime: 2019-09-25 10:01:37
 * @LastEditors: Please set LastEditors
 -->
<template>
  <div class="sun-tab-scroll">
    <sun-tabs v-if="showMainTab" @click="changeMainTab" v-model="mainTabIndex" sticky swipeable :line-width="lineWidth"
      :type="type" :duration="duration" :swipeThreshold="swipeThreshold" class="sun-tab-scroll-tabs"
      style="z-index: 999;">
