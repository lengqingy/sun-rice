 ...
 * @LastEditTime: 2019-09-25 09:39:47
 * @LastEditors: Please set LastEditors
 -->
<template>
  <div class="sun-picker-cell">
    <sun-cell :title="title" :value="computeValue" :border="border" center clickable arrowDirection="right"
      @click="clickCell">
      <slot name="extra" v-if="placeholder && !computeValue"><span
          class="sun-picker-cell-placeholder">{{placeholder}}</span></slot>
    </sun-cell>
    ...
    <sun-popup v-model="showPicker" :zIndex="zIndex" position="bottom" :get-container="getContainer"
      ...
      <sun-datetime-picker v-show="showPicker" :title="title" :value="computeDate" :border="border"
        :itemHeight="itemHeight" :visibleItemCount="visibleItemCount" :confirmButtonText="confirmButtonText"
        :cancelButtonText="cancelButtonText" :type="type" :showToolbar="showToolbar" :format="format" :minDate="minDate"
        :maxDate="maxDate" :minHour="minHour" :maxHour="maxHour" @cancel="onCancel" @confirm="onConfirm" />
    </sun-popup>
  </div>
</template>
